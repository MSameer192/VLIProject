...
const Footer = () => {
    ...
    // h-[625px]
    return (
        <footer className='pt-[130px] md:pt-[100px] mt-32 md:mt-0 w-full  md:max-h-[auto] relative md:h-fit flex flex-col items-center gap-3 md:gap-10 lg:gap-40 rounded-t-[50px] md:rounded-t-[0px] md:bg-[#F1FAFF] FooterLinearGradient md:overflow-hidden -z-10'>
