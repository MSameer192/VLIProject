...
const PopularCourses = () => {
    ...
    return (
        <div className='relative flex flex-col justify-start items-center gap-5'>
            ...
            <div className='relative flex w-4/5 justify-center items-center flex-col lg:flex-row lg:justify-between gap-8'>
                <ul className='flex flex-col text-4xs md:text-3xs  gap-12 lg:gap-[70px] '>
                ...
                <img className='w-full sm:w-[80%] lg:w-[55%] xl:w-[60%] 2xl:w-auto lg:inline-block'
...
function PopularCoursesTiles({ PopularCoursesInfo }) {
    ...
    return <div className='relative flex flex-col justify-start w-full gap-4'>
        <div className='relative w- mx-2 mt-5 overflow-hidden md:flex md:justify-center'>
            <div
                style={{ left: -Size + "px" }}
                className='relative w-fit duration-300 flex gap-7 flex-row justify-start items-start flex-nowrap md:flex-wrap md:justify-center lg:gap-4'>
                {PopularCoursesInfo?.map((value, index) => {
                    return (
                        <div className={`min-w-[252px] w-[60%] md:w-[325px] max-w-[320px]
                        flex flex-col rounded-[20px] p-2 md:p-5 items-center h- relative hover:cursor-pointer hover:bg-[#BCBEFF] duration-300 bg-white md:bg-[#00000000] `}
                            ref={(e) => { setref(e) }}
                        >
                            <div className='flex flex-col items-center '>
                                <div className='w-full relative m-8 mb-0'>
                                ...
                                <span className='w-[102px] md:w-[145px] h-[35px] md:-h-[50px] relative -top-[20px] md:-top-[40px] flex justify-center items-center bg-white  rounded-[14px] PriceShadow'>
                            ...
                            <div className='flex flex-col items-center gap-2'>
                                ...
                                <p className='max-w-[250px] text-[12px] Regularfont text-center'>{value.CourseDescription}</p>
                            </div>


                            <div className='flex  justify-between items-center w-full md:w-[85%] mt-10 '>
                                <div className='flex flex-col'>
                                    <span>* * * * *</span>
                                    <span className='SemiBold text-xs'><img src={require('./Assets/Thumb Icon.svg').default} alt="" /> 100%</span>
                                </div>
                                <h5 className='Regularfont font-thin tex-[12px] md:text-4xs'>30 Lectures course</h5>
                            </div>
                        </div>
                    )
                })}
