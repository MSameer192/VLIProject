...
const VehicleCredentials = ({ VehicleData, setVehicleData, VehicleErrors, setVehicleErrors }) => {
    ...
    return (
        <div className={`w-11/12 mt-10 sm:bg-white flex flex-col gap-10 py-6 items-center sm:items-start
            ...
            <h2 className='Boldfont text-[#707070] font-normal text-3xs md:text-2xs xl:text-sm'>Registration and Insurance</h2>

            <div className='w-full flex flex-col gap-7 mx-5 '>
                <div className={DivStyle}>
                    <label className={TextStyle} htmlFor="IdentityNumber">Identity Number</label>
                ...
                <div className={DivStyle}>
                    <label className={TextStyle} htmlFor="PlateNumber">Plate Number</label>
                    <span className={InputParentSpanStyle}>
                ...
                <div className={DivStyle}>
                    <label className={TextStyle} htmlFor="InsuranceNumber">Insurance Number</label>
                    <span className={InputParentSpanStyle}>
                ...
                <div className={DivStyle}>
                    <label className={TextStyle} htmlFor="TrainerNumberPlate">Trainer Number Plate</label>
                    <span className={InputParentSpanStyle}>
