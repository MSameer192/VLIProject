...
import { GetInstituteInstructorsA, GetInstructorsA } from '../../../Actions/InstructorA'
            ...
            <table className="addCourse4Table">
                ...
                <tbody>
                    ...
                    {Instructors?.map((value, index) => {
                        ...
                        const Edit = () =>
                            <Link to={`/instructor/update/${value.Instructor.InstructorId}`}>
                        ...
                        console.log(value?.Instructor?.TimeTable, !Status ? "free" : Status)
...
const InstructorsList = () => <InstituteTemplate Element={InstructorsListChild} bg="bg-[#F7F7F7] min-h-screen items-center" />
