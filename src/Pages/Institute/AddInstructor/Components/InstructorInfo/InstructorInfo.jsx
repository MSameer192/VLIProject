...
const InstructorInfo = ({ InstructorData, setInstructorData, Err, setErr }) => {
  ...
  return (
    <div className="flex w-full flex-col flex-wrap justify-between gap-10 gap-y-6 sm:w-full  md:w-[95%] md:flex-row lg:w-[85%]">
      <Input
        Label="First name"
        Placeholder="John"
        Id="FirstName"
      ...
      <Input
        ...
        Placeholder="PQ512654"
        Id="LicenseNumber"
        Err={Err?.LicenseNumber}
