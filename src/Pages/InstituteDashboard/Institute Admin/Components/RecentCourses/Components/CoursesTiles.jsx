...
const CoursesTiles = ({ Courses, OnClick }) => {
    ...
    return (
        Courses?.map((value) => {
            ...
            let Color = value?.Publish === "Approved" ? "text-[#00FF11] bg-[#00FF1129]" : 'bg-[#FF9C46] text-[#FF9C46]'
            return (
                <div
                        ...
                        <div className="cardBody w-[70%] flex justify-between  ">
                            ...
                            <div className="w-[27%] max-w-[230px] pr-[30px] mt-[24px] cardFoterWidth">
                                <div className="flex flex-col  items-center cardFoter">
                                    ...
                                    <button className={`rounded-[6px] py-[11px] px-[16px] text-center text-[13px] leading-[13px]  bg-opacity-20 mt-[18px] mb-[25px] w-[118px] border-none ${Color}`}>
                                        {value?.Publish}
                                    </button>
