    ...
    return (
        <div className='OnAddPopup-BG'>
            <div className='OnAddPopup-Container'>
                <img className='absolute right-3 top-[6px] cursor-pointer' src={require('./Assets/Cross.svg').default} alt="" onClick={() => Navigate('/')}/>
                ...
                <button className='BrandingButton text-6xs px-9 py-1 rounded-2xl z-10' type='button' onClick={() => Navigate('/')}>
                    Okay
                </button>
            </div>
        </div>
