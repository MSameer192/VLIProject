...
const ForSubcategories = ({ Type }) => {
    ...
    return (
      ...
      ClassGLicensingMobileGradient`}>
            ...
            <MainPart SubLicenseTypes={Type?.SubLicenseTypes} />
        </div>
...
function MainPart({ SubLicenseTypes }) {
  
    return <div className='flex flex-col gap-[88px] mt-10 sm:mt-0 w-11/12'>
    ...
    `}>
            ...
            {SubLicenseTypes.map(value => 
                 <Tiles Heading={value?.SubLicenseTypeName} Detail='Level One of graduated licensing' IMG={require('../../Assets/Level1Icon.svg').default} />
            )}
