...
function BuyingSide({ CourseInfo }) {
    let ButtonStyle = "text-white bg-[#A1A3EF] text-sm text-center py-6 rounded-[9px]  whitespace-nowrap border-none px-10 cursor-pointer SemiBold"
    ...
    return <div className='hidden bg-white sm:flex flex-col gap-9 px-12 py-14 rounded-[14px] relative -top-20 z-20'>
        <div className=' flex flex-col gap-4'>
            ...
            <span className="flex flex-col gap-5">
                <button onClick={NavigateToEnrollment} className={ButtonStyle}>
                    Enroll for 2000/Rs
                </button>
