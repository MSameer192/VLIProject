...
/* Dummy ROutes 3 Feb Friday*/
import CourseSelection from "./Pages/AddCourse/Components/CourseSelection/CourseSelection";
import Pricing from "./Pages/AddCourse/Components/Pricing/Pricing";
import Description from "./Pages/AddCourse/Components/Description/Description";
import InstructorsSelection from "./Pages/AddCourse/Components/Instructors Selection/Instructors Selection";
import VehicalInventory from "./Pages/AddCourse/Components/vehicalInventory/VehicalInventory";
import AdminApprovedCourses from "./Pages/AddCourse/Components/adminApprovedCourses/AdminApprovedCourses";
    ...
    <SocketContext.Provider value={Socket}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/InstructorsSelection" element={<InstructorsSelection />} />
          <Route path="/vehicalInventory" element={<VehicalInventory />} />
          <Route path="/AdminApprovedCourses" element={<AdminApprovedCourses />} />
